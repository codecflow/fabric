...
func (k *KubernetesProvider) Type() provider.ProviderType {
	return provider.ProviderTypeKubernetes
}
...
func (k *KubernetesProvider) GetAvailableResources(ctx context.Context) (*provider.ResourceAvailability, error) {
...
func (k *KubernetesProvider) GetPricing(ctx context.Context) (*provider.PricingInfo, error) {
...
func (k *KubernetesProvider) GetStatus(ctx context.Context) (*provider.ProviderStatus, error) {
